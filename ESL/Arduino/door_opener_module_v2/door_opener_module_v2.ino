...
void getI2cMessage(){
  ...
  switch (i2cState) {
    ...
    case COMMAND :
      ...
      softSerial.println(messageByte);
      i2cCommand = messageByte;
      i2cState = SIZE;
      break;
    case SIZE :
      softSerial.println("SIZE");
    ...
    case DATA :
      ...
      softSerial.println(i2cDataReceiveBuffer[i2cDataSizeIndex]);
      i2cDataSizeIndex++;
...
void processProtocol(){
  ...
  if(i2cCommand == 0x20){// Check Status Module
     softSerial.println(F(">CheckModule"));
