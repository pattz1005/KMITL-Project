...
board(X00,X10,X20,X30,X40,X50,X60,X70,
	...
	%board(gemval(0,0,X00),gemval(1,0,X10),gemval(2,0,X20),gemval(3,0,X30),gemval(4,0,X40),gemval(5,0,X50),gemval(6,0,X60),gemval(7,0,X70),
	%gemval(0,1,X01),gemval(1,1,X11),gemval(2,1,X21),gemval(3,1,X31),gemval(4,1,X41),gemval(5,1,X51),gemval(6,1,X61),gemval(7,1,X71),
	%gemval(0,2,X02),gemval(1,2,X12),gemval(2,2,X22),gemval(3,2,X32),gemval(4,2,X42),gemval(5,2,X52),gemval(6,2,X62),gemval(7,2,X72),
	%gemval(0,3,X03),gemval(1,3,X13),gemval(2,3,X23),gemval(3,3,X33),gemval(4,3,X43),gemval(5,3,X53),gemval(6,3,X63),gemval(7,3,X73),
	%gemval(0,4,X04),gemval(1,4,X14),gemval(2,4,X24),gemval(3,4,X34),gemval(4,4,X44),gemval(5,4,X54),gemval(6,4,X64),gemval(7,4,X74),
	%gemval(0,5,X05),gemval(1,5,X15),gemval(2,5,X25),gemval(3,5,X35),gemval(4,5,X45),gemval(5,5,X55),gemval(6,5,X65),gemval(7,5,X75),
	%gemval(0,6,X06),gemval(1,6,X16),gemval(2,6,X26),gemval(3,6,X36),gemval(4,6,X46),gemval(5,6,X56),gemval(6,6,X66),gemval(7,6,X76),
	%gemval(0,7,X07),gemval(1,7,X17),gemval(2,7,X27),gemval(3,7,X37),gemval(4,7,X47),gemval(5,7,X57),gemval(6,7,X67),gemval(7,7,X77)).
	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	
% Append
%[1] append[] and Y to get Y.
%[2] append [H|X] and Y to get [H|Z] if append X
% and Y to get Z
%
...
% vertical_stack0 = [X07,X06,X05,X04,X03,X02,X01,X00,99,99,99].
% vertical_stack1 = [X17,X16,X15,X14,X13,X12,X11,X10,99,99,99].
% vertical_stack2 = [X27,X26,X25,X24,X23,X22,X21,X20,99,99,99].
% vertical_stack3 = [X37,X36,X35,X34,X33,X32,X31,X30,99,99,99].
% vertical_stack4 = [X47,X46,X45,X44,X43,X42,X41,X40,99,99,99].
% vertical_stack5 = [X57,X56,X55,X54,X53,X52,X51,X50,99,99,99].
% vertical_stack6 = [X67,X66,X65,X64,X63,X62,X61,X60,99,99,99].
% vertical_stack7 = [X77,X76,X75,X74,X73,X72,X71,X70,99,99,99].
...
printposition(X1,Y1,X2,Y2,X3,Y3) :-
	format("(~w,~w), (~w,~w), (~w,~w) | Score=1",[X1,Y1,X2,Y2,X3,Y3]), nl.
	
printposition2(X1,Y1,X2,Y2,X3,Y3) :-
	format("(~w,~w), (~w,~w), (~w,~w) | Score=2",[X1,Y1,X2,Y2,X3,Y3]), nl.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% A function to solve entire board (new data structures)
solve_board() :-

	% Sample board
	X = board(5,1,5,6,2,4,5,1,
		3,2,6,7,5,6,4,6,
		1,5,1,1,7,4,5,3,
		5,1,7,4,1,1,7,1,
		6,2,5,2,3,4,3,4,
