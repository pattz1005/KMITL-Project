...
%% วิธีการใช้โปรแกรม 
%% 1. รันไฟล์นี้
%% 2. ในหน้า console พิมพ์ ?- sample().
%% 3. กดปุ่ม ; ไปเรื่อยๆ จนกว่าจะหมด

% ตัวอย่างที่เอามาจาก report
sample() :-
...
% กระดานสำหรับทดสอบ แก้ได้ตามสบาย
sample2() :-
	solve(5,5,3,5,2,4,5,1,
		3,2,5,7,5,6,4,6,
		1,5,1,2,7,4,5,3,
		5,3,7,4,1,1,7,1,
		6,2,5,3,3,4,3,4,
...
% check: if 3 items are equal, print a position	
...
solve(X00,X10,X20,X30,X40,X50,X60,X70,
	...
	% 40 possible cases
	check3(X00,X20,X30,0,0,1,0,3,0);
	check3(X10,X30,X40,1,0,2,0,4,0);
	check3(X20,X40,X50,2,0,3,0,5,0);
	check3(X30,X50,X60,3,0,4,0,6,0);
	check3(X40,X60,X70,4,0,5,0,7,0);
	check3(X01,X21,X31,0,1,1,1,3,1);
	check3(X11,X31,X41,1,1,2,1,4,1);
	check3(X21,X41,X51,2,1,3,1,5,1);
	check3(X31,X51,X61,3,1,4,1,6,1);
	check3(X41,X61,X71,4,1,5,1,7,1);
	check3(X02,X22,X32,0,2,1,2,3,2);
	check3(X12,X32,X42,1,2,2,2,4,2);
	check3(X22,X42,X52,2,2,3,2,5,2);
	check3(X32,X52,X62,3,2,4,2,6,2);
	check3(X42,X62,X72,4,2,5,2,7,2);
	check3(X03,X23,X33,0,3,1,3,3,3);
	check3(X13,X33,X43,1,3,2,3,4,3);
	check3(X23,X43,X53,2,3,3,3,5,3);
	check3(X33,X53,X63,3,3,4,3,6,3);
	check3(X43,X63,X73,4,3,5,3,7,3);
	check3(X04,X24,X34,0,4,1,4,3,4);
	check3(X14,X34,X44,1,4,2,4,4,4);
	check3(X24,X44,X54,2,4,3,4,5,4);
	check3(X34,X54,X64,3,4,4,4,6,4);
	check3(X44,X64,X74,4,4,5,4,7,4);
	check3(X05,X25,X35,0,5,1,5,3,5);
	check3(X15,X35,X45,1,5,2,5,4,5);
	check3(X25,X45,X55,2,5,3,5,5,5);
	check3(X35,X55,X65,3,5,4,5,6,5);
	check3(X45,X65,X75,4,5,5,5,7,5);
	check3(X06,X26,X36,0,6,1,6,3,6);
	check3(X16,X36,X46,1,6,2,6,4,6);
	check3(X26,X46,X56,2,6,3,6,5,6);
	check3(X36,X56,X66,3,6,4,6,6,6);
	check3(X46,X66,X76,4,6,5,6,7,6);
	check3(X07,X27,X37,0,7,1,7,3,7);
	check3(X17,X37,X47,1,7,2,7,4,7);
	check3(X27,X47,X57,2,7,3,7,5,7);
	check3(X37,X57,X67,3,7,4,7,6,7);
	check3(X47,X67,X77,4,7,5,7,7,7);
	...
	check3(X07,X17,X37,0,7,1,7,3,7);
	check3(X17,X27,X47,1,7,2,7,4,7);
	check3(X27,X37,X57,2,7,3,7,5,7);
	check3(X37,X47,X67,3,7,4,7,6,7);
	check3(X47,X57,X77,4,7,5,7,7,7);
	...
	%		    [X_]
	%			[X_]
	% (x,y+1), (x,y+1), (x,y+2) : x is 1..7, y is 1..6
	% 42 possible cases
	check3(X01,X01,X02,0,1,0,1,0,2);
	check3(X11,X11,X12,1,1,1,1,1,2);
	check3(X21,X21,X22,2,1,2,1,2,2);
	check3(X31,X31,X32,3,1,3,1,3,2);
	check3(X41,X41,X42,4,1,4,1,4,2);
	check3(X51,X51,X52,5,1,5,1,5,2);
	check3(X61,X61,X62,6,1,6,1,6,2);
	check3(X02,X02,X03,0,2,0,2,0,3);
	check3(X12,X12,X13,1,2,1,2,1,3);
	check3(X22,X22,X23,2,2,2,2,2,3);
	check3(X32,X32,X33,3,2,3,2,3,3);
	check3(X42,X42,X43,4,2,4,2,4,3);
	check3(X52,X52,X53,5,2,5,2,5,3);
	check3(X62,X62,X63,6,2,6,2,6,3);
	check3(X03,X03,X04,0,3,0,3,0,4);
	check3(X13,X13,X14,1,3,1,3,1,4);
	check3(X23,X23,X24,2,3,2,3,2,4);
	check3(X33,X33,X34,3,3,3,3,3,4);
	check3(X43,X43,X44,4,3,4,3,4,4);
	check3(X53,X53,X54,5,3,5,3,5,4);
	check3(X63,X63,X64,6,3,6,3,6,4);
	check3(X04,X04,X05,0,4,0,4,0,5);
	check3(X14,X14,X15,1,4,1,4,1,5);
	check3(X24,X24,X25,2,4,2,4,2,5);
	check3(X34,X34,X35,3,4,3,4,3,5);
	check3(X44,X44,X45,4,4,4,4,4,5);
	check3(X54,X54,X55,5,4,5,4,5,5);
	check3(X64,X64,X65,6,4,6,4,6,5);
	check3(X05,X05,X06,0,5,0,5,0,6);
	check3(X15,X15,X16,1,5,1,5,1,6);
	check3(X25,X25,X26,2,5,2,5,2,6);
	check3(X35,X35,X36,3,5,3,5,3,6);
	check3(X45,X45,X46,4,5,4,5,4,6);
	check3(X55,X55,X56,5,5,5,5,5,6);
	check3(X65,X65,X66,6,5,6,5,6,6);
	check3(X06,X06,X07,0,6,0,6,0,7);
	check3(X16,X16,X17,1,6,1,6,1,7);
	check3(X26,X26,X27,2,6,2,6,2,7);
	check3(X36,X36,X37,3,6,3,6,3,7);
	check3(X46,X46,X47,4,6,4,6,4,7);
	check3(X56,X56,X57,5,6,5,6,5,7);
	check3(X66,X66,X67,6,6,6,6,6,7);
