function PowerLawTransformImage
%% 
...
RGB=imread('mammography_800x600.jpg');
%%
...
figure, imshow(I3);title(['Power-law transformation Gamma = ' num2str(g(r))]);xlabel('Gamma='),xlabel(g(r));
end